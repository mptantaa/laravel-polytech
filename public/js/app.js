...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    var _this = this;
    window.Echo.channel('my-channel').listen('CreateArticleEvent', function (name) {
      console.log(name);
      _this.msg = name.name;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    ...
    role: "alert"
  }, " Добавлена новая статья " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(this.msg), 513 /* TEXT, NEED_PATCH */)), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, this.msg != null]]);
}
